...
public class Tags extends TableImpl<TagsRecord> {
	...
	private static final long serialVersionUID = -1446848112;
	...
	/**
	 * The column <code>public.tags.added</code>.
	 */
	public final TableField<TagsRecord, Time> ADDED = createField("added", org.jooq.impl.SQLDataType.TIME.defaulted(true), this, "");
